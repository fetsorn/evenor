 ...
 * @returns {object[]}
 */
export async function readRemoteTags(api, mind) {
  try {
 ...
 * @returns {object}
 */
export async function readLocalTags(api, mind) {
  try {
 ...
 * @returns {object}
 */
export async function writeRemoteTags(api, mind, originUrls) {
 ...
 * @returns {object}
 */
export async function writeLocalTags(api, mind, tags) {
