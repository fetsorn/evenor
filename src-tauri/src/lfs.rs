...
#[tauri::command]
pub async fn fetch_asset<R: tauri::Runtime>(
    app: AppHandle<R>,
    uuid: &str,
    filename: &str,
) -> Result<()> {
...
#[tauri::command]
pub async fn put_asset<R: tauri::Runtime>(
    app: AppHandle<R>,
    uuid: &str,
    filename: &str,
    buffer: &str,
...
#[tauri::command]
pub async fn upload_blobs_lfs<R: tauri::Runtime>(
    app: AppHandle<R>,
    uuid: &str,
    remote: &str,
    files: &str,
...
#[tauri::command]
pub async fn download_asset<R: tauri::Runtime>(
    app: AppHandle<R>,
    uuid: &str,
    content: &str,
    filename: &str,
...
#[tauri::command]
pub async fn add_asset_path<R: tauri::Runtime>(
    app: AppHandle<R>,
    uuid: &str,
    asset_path: &str,
) -> Result<()> {
