...
export default class ElectronAPI {
  ...
  static async uploadFile(_event, dir) {
  ...
  static async select(_event, searchParams) {
  //
  }

  static async queryOptions(_event, branch) {
  //
  }

  static async updateEntry(_event, entry, overview) {
  //
  }

  static async deleteEntry(_event, entry, overview) {
  //
  }
  ...
  static async commit(_event, dir) {
    const message = [];
  ...
  static async push(_event, token) {
  //
  }

  static async pull(_event, token) {
  //
  }

  static async addRemote(_event, url) {
  //
  }

  static async ensure(_event, dir, schema) {
    const root = path.join(home, ".qualia");
  ...
  static async symlink(_event, dir, name) {
    const root = path.join(home, ".qualia");
  ...
  static async rimraf(_event, filepath) {
    const root = path.join(home, ".qualia");
  ...
  static async ls(_event, filepath) {
  //
  }

  static async getRemote(_event, repodir) {
    const root = path.join(home, ".qualia");
  ...
  static async openPDF(_event, url) {
